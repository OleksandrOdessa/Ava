...
***************************************************************************** */
    ...
    window.onload = function() {
        const parallax = document.querySelector(".main-head");
        if (parallax) {
            document.querySelector(".main-head__body");
            const teacher = document.querySelector(".images-parallax__teacher");
            const big = document.querySelector(".images-parallax__three-b");
            const middle = document.querySelector(".images-parallax__three-m");
            const small = document.querySelector(".images-parallax__three-s");
            const forTeacher = 20;
            const forBig = 3;
            const forMiddle = .8;
            const forSmall = .4;
            ...
            function setMouseParallaxStyle() {
                ...
                teacher.style.cssText = `transform: translate(${positionX / forTeacher}%,${positionY / forTeacher}%);`;
